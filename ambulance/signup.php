	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Find Your Ambulance</h2>
				<h3 class="properties" style="text-align: center">Air Ambulance - AC/Non-AC Ambulance - ICU Ambulance</h3>
			</section>
	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>CliniCare team is an organized company that rents Ambulance.</p>
					<ul>
		...
		<div class="copyrights wrapper">
			Copyright &copy; <?php echo date("Y")?> All Rights Reserved | Designed by CliniCare.
		</div>
	</footer><!--  end footer  -->
